    ...
    <div class="container">
        ...
        <main class="contenido-principal">
            ...
            <div class="container-formulario">
                <form method="POST" action="index.php?action=productos&method=actualizar&id=<?php echo $producto['id']; ?>" class="formularios">
                    ...
                    <div class="grupo-formulario">
                        ...
                        <small>Opcional - Puedes crear categorias desde la seccion de Categorias</small>
                    </div>
