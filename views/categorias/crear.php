...
<head>
    ...
    <title>Nueva Categoría | Sistema de Inventario</title>
...
<body>
    <div class="container">
        ...
        <main class="contenido-principal">
            ...
            <div class="container-formulario">
                <form method="POST" action="index.php?action=categorias&method=crear" class="formularios">
    ...
    <script src="assets/js/forms_simple.js"></script>
</body>
</html>
